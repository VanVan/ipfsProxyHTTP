...
class ipfsProxyHTTP {
    ...
    protected function redirect($ipfs_uri) {
        if (((isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER']) || strpos($_SERVER['HTTP_ACCEPT'], 'text/html') === FALSE) && ((strpos($_SERVER['HTTP_REFERER'], $_SERVER['HTTP_HOST']) === FALSE) || substr($ipfs_uri, -3) == 'png'))
